  ...
  return (
    <>
      <section className="flex flex-col-reverse lg:flex-row items-center max-w-[1440px] mx-auto justify-between px-6 mt-10 lg:px-20 py-14 shadow-xl bg-offwhite" id="home">
          ...
          <div className="lg:w-1/2 m-10 lg:mt-0 2xl:w-1/4">
            <img
              src={hero}
              alt="hero"
      ...
      <section className="flex flex-col-reverse lg:flex-row items-center max-w-[1440px] mx-auto justify-between px-6 lg:px-20 py-22" id="about">
        <div className="lg:w-1/2 text-center lg:text-left space-y-6">
      ...
      <section className="px-6 lg:px-20 pb-12 max-w-[1440px] mx-auto" id="features">
      ...
      <section className="px-6 lg:px-20 py-16 max-w-[1440px] mx-auto" id="demo">
        <div className="flex flex-row pb-12">
        <img
              src={sparkle}
              alt="sparkle-bullet-point"
              className="w-14 h-auto transition-all duration-300 ease-in-out"
          />
        <h2 className="text-3xl tracking-wider lg:text-4xl font-bold text-center max-sm:text-left sparkle-text pl-4">How to use Clarify</h2>
